...
#the amount of users
lu = user.shape[0]
poi1data = pd.read_csv("F:\zhudanyang\LBS1222\Flbsdataset2\shopping.csv", index_col=0)
#poi1data = pd.read_csv("F:\zhudanyang\LBS9.30\Flbsdataset\SimpleRestaurant.csv", index_col=0)
#poi1data = pd.read_csv("F:\zhudanyang\LBS9.30\Flbsdataset\Health Services.csv", index_col=0)
#the amount of POIs
lenp = poi1data.shape[0]


result = pd.read_csv("F:\zhudanyang\LBS1222\Flbsdataset2\\result\dimension-simplegeo-knn6.csv", index_col=0)
...
for k in range(1,51):
    ...
    result.iloc[o, 2] = resemblance[o]
    result.iloc[o, 3] = displacement[o]

print(resemblance)
print(displacement)
result.to_csv("F:\zhudanyang\LBS1222\Flbsdataset2\\result\dimension-simplegeo-knn6.csv")